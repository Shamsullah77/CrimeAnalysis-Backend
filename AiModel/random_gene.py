...
df_balanced = pd.concat([pd.DataFrame(X_balanced, columns=X.columns), pd.DataFrame(y_balanced, columns=['crime_type'])], axis=1)

# Save to CSV
df_balanced.to_csv('balanced_data.csv', index=False)

print("Data has been generated, balanced, and saved to 'balanced_data.csv'.")
